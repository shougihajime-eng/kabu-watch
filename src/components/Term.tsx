...
const GLOSSARY: Record<string, string> = {
  ...
  信号機: "AIが「今買って良いか」をひと目で分かるように、青（買い時かも）・黄（様子見）・赤（今は避ける）の3段階で示したもの。自信度・買われすぎ・トレンドなど複数の指標を組み合わせて判定している。",
  最悪いくら損するか: "過去90日のチャートで、その銘柄がいちばん大きく下げた時の下落率を元に「いま買って同じことが起きたらいくら損するか」を試算した参考値。これより悪くなる可能性も0ではない。",
  最大ドローダウン: "ある期間で「高値からどれだけ下げたか」の最大値。過去の値動きの荒さ・最悪ケースを見るのに使う。",
};
